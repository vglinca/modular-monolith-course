...
internal sealed class ContractRegistry : IContractRegistry
{
    ...
    public IContractRegistry RegisterPath(string path) => RegisterPath<Empty, Empty>(path);
    ...
    private static void ValidateProperty(PropertyInfo localProperty, PropertyInfo originalProperty,
        string propertyName, string contractName, string module, string localModule,
        string path = null)
    {
