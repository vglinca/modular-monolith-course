...
internal sealed class AddWithdrawalAccountCommandHandler : ICommandHandler<AddWithdrawalAccount>
{
    private readonly IWithdrawalAccountRepository _withdrawalAccountRepository;
    private readonly ICustomerRepository _customerRepository;
    private readonly IMessageBroker _messageBroker;
    private readonly IClock _clock;
    private readonly ILogger<AddWithdrawalAccountCommandHandler> _logger;

    public AddWithdrawalAccountCommandHandler(IWithdrawalAccountRepository withdrawalAccountRepository, 
        ICustomerRepository customerRepository, IMessageBroker messageBroker, IClock clock, 
        ILogger<AddWithdrawalAccountCommandHandler> logger)
    {
